...
typedef NS_OPTIONS(uint16_t, GPBFieldFlags) {
  ...
  // be used in new generated code. It can not be reeused until the 30007 generated format is no
  // longer supported.
  ...
  // longer be used in new generated code. It can not be reeused until the 30007 generated format is
  // no longer supported.
